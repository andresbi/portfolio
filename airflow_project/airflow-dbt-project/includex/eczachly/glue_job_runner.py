...
# local_script_path = os.path.join("include", 'eczachly/scripts/google_search_results_api_example.py')
# create_and_run_glue_job('google_example_job',
#                         script_path=local_script_path,
#                         arguments={'--ds': '2024-11-21', '--output_table': 'zachwilson.test_google_results_example'})
